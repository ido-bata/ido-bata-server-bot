...
export const CONSUMERS: readonly ConsumerEntry[] = [
  // Consent-gated (5)
  {
    id: "timekeeper-history",
    label: "Timekeeper attendance history",
    bucket: "consent-gated",
  ...
  {
    id: "state-snapshot",
    label: "Encrypted state snapshots",
    bucket: "consent-gated",
    scope: "activity-history",
    dataFile: "data/snapshots/",
    rationale:
      "Encrypted AES-256-GCM bundles of source files; expiry triggered via applyRetentionPlan",
  },

  // Operational (5)
  {
    id: "timekeeper-session-log",
    label: "Timekeeper session log",
    bucket: "operational",
  ...
  },
  {
    ...
    label: "Scheduled announcements cadence",
    bucket: "operational",
  ...
  },
  {
    ...
    label: "Hot-reload operator config",
    bucket: "operational",
  ...
  {
    id: "multi-guild",
    label: "Per-guild operator config",
    bucket: "operational",
  ...
  {
    id: "game-activity",
    label: "Game activity (presence)",
    bucket: "ephemeral",
    scope: "presence-history",
  },
  {
    id: "spotify",
    label: "Spotify now-playing (presence)",
    bucket: "ephemeral",
    scope: "presence-history",
  },
  ...
  {
    id: "message-audit",
    label: "Message edit/delete audit",
    bucket: "ephemeral",
